...
import com.reemastyle.reschedule.RescheduleBooking
import com.reemastyle.util.Utils
import kotlinx.android.synthetic.main.time_slots_adapter_layout.view.*

class TimeSlotsAdapter(private var context: Context, private var timeSlotSelected: TimeSlotSelected, private var slotList: ArrayList<SlotsItem>) : RecyclerView.Adapter<TimeSlotsAdapter.MyViewHolder>() {
