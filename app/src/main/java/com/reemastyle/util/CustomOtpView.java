...
public class CustomOtpView extends LinearLayout implements View.OnFocusChangeListener, TextWatcher, View.OnKeyListener {
    ...
    public CustomOtpView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.custom_otp_view, this);
