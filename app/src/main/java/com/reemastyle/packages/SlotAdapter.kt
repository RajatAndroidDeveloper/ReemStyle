...
class SlotAdapter (private var context: Context, private var timeSlotSelected: TimeSlotSelected, private var slotList: ArrayList<SlotsItem>) : RecyclerView.Adapter<SlotAdapter.MyViewHolder>() {
